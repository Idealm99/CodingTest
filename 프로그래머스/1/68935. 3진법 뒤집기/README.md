...
이런 코드가 있는데 이 코드는 문자열로 된 12 를 3진법으로 해석해서 10진법인 int형으로 변환하는 것이다

int('34',16) 이 코드는 34를 16진법으로 인식해서 10진법 인트형으로 변환하여 54가 된다. 

*bin(int), oct(int), hex(int)는 10진수를*

*2진수 8진수 16진수로 바꿔주는 함수이다.* 
