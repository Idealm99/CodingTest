...
리스트의 길이가 길면 그 리스트 안에서 삭제하거나 변경하는게 오래 걸리니 새로운 리스트를 만들어서 추가하면서 확인하고

li = li[-4:] 이런 식으로 작성하면 자원을 더 많이 사용하여 시간이 더욱 오래 걸린다 그러므로 del로 제거하는 것이 더욱 좋은 방법이다 
