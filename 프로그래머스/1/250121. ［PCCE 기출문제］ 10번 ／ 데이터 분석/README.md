...
sort 함수에서 key는 정렬 기준을 정의하는 함수를 전달받아 정렬 기준을 정의할 수 있다.

key 매개변수에는 len, sum 등의 기본 함수, 직접 정의한 함수, 그리고 간단한 함수를 정의하는 람다 함수를 사용할 수 있다.

이번 과제에서는 람다 함수를 사용하여 정렬 기준을 정의했다.

람다 함수를 사용하는 방법
lambda x: x + 1 이런 식으로 사용할 수 있다
